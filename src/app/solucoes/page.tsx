      ...
      <main className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className={styles.grid}>
          {[
            ...
            { tag: 'EDT', id: 'academy', titulo: 'Edtech Academy', desc: 'Plataforma LMS completa para letramento digital da equipe e capacitação preditiva.', link: '#', externo: false, icon: <Users size={22} />, color: '#EF4444', hasAccess: false, foto: '/arkos_edtech_portal_hero_v1_1774542625280.png' },
