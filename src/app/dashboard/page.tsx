...
export default function DashboardPage() {
  ...
  const apps = [
    ...
    { tag: 'EDT', id: 'academy', title: 'Edtech Academy', status: 'Desenvolvimento', desc: 'Plataforma LMS completa para letramento digital da equipe e capacitação preditiva.', image: '/arkos_edtech_portal_hero_v1_1774542625280.png', color: '#EF4444', link: '#' },
