        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: '60px', alignItems: 'start', marginBottom: '80px' }}>
          ...
          <div style={{ paddingTop: '8px' }}>
            ...
            <p style={{ color: '#8A8F99', fontSize: '0.95rem', lineHeight: 1.9, marginBottom: '28px' }}>
              Fundador da <strong style={{ color: '#F4F2ED' }}>Econsult</strong>, empresa de consultoria organizacional especializada em planejamento estratégico, gestão financeira, perícia contábil e pesquisas quantitativas, Renato acumula experiência tanto no setor público quanto no privado. Hoje, além de atuar como gerente do sistema no Cidade Viva Education e professor de pós-graduação na FICV, é o idealizador e founder da <strong style={{ color: '#C8F542' }}>Arkos Intelligence</strong> — infraestrutura analítica que traduz décadas de expertise em tecnologia de gestão de alto impacto.
            </p>
